...
export const GuildScalarFieldEnum = {
  ...
  forceAnonymousReviews: 'forceAnonymousReviews',
  createThreads: 'createThreads',
  reviewButton: 'reviewButton',
  usefulButton: 'usefulButton',
  ratingEmoji: 'ratingEmoji',
  reviewTitle: 'reviewTitle',
  customReviewButton: 'customReviewButton',
  customReviewEmbed: 'customReviewEmbed',
  customReviewEmbedId: 'customReviewEmbedId',
  reviewRoles: 'reviewRoles',
  blacklistedRoles: 'blacklistedRoles',
  adminRoles: 'adminRoles',
  autoReviewRole: 'autoReviewRole',
